...
(function (V) {
  ...
  StartScene.prototype.render = function (ctx, cw, ch) {
    ...
    /* ---- the hero, standing on the skyline, left of the menu ----
       ...
       by where he stands rather than by a corner. Sized off the screen HEIGHT
       and pushed far enough right that a narrow phone does not clip his arm,
       while the menu stays centred and clear of him in both orientations. */
    var hero = V.Spr.player('down', 0, this.game.playerTint());
    var hScale = Math.max(3, Math.round((ch * 0.36) / hero.h));
    ...
    /* stacked buttons, centred and held above his head in both orientations */
